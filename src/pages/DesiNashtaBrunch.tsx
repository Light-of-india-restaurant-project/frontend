...
import { Coffee, Sun, Clock, MapPin, Flame, Leaf, Star, ChevronDown } from "lucide-react";
...
const DesiNashtaBrunch = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Reservation Form — immediately after hero so it's the first thing users reach */}
